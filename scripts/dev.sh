...
cross-env NEXT_PUBLIC_GIT_SHA=$(git rev-parse --short HEAD) GCLOUD_PROJECT=miniext-coding-challenge FIREBASE_AUTH_EMULATOR_HOST="127.0.0.1:9099" FIRESTORE_EMULATOR_HOST="127.0.0.1:8081" PORT=3000 FIREBASE_STORAGE_EMULATOR_HOST="127.0.0.1:9199" yarn next dev -p 3000